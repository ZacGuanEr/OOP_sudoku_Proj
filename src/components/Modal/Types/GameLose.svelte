<script>
	...
	import { usedHints, hints } from '@sudoku/stores/hints';

	const gameLoseWarning = 'You lose the fucking game!!!'

	function handleShare() {
		modal.show('share', { onHide: () => modal.show('gamelose'), onHideReplace: true });
	}
...
<div class="flex flex-col text-center items-center">
	...
	<h1 class="text-4xl font-semibold">{gameLoseWarning}</h1>
</div>
...
<button class="btn btn-small w-full mb-2" on:click={handleNewGame}>New Game</button>
<!-- <button class="btn btn-small btn-primary w-full" on:click={handleNewGame}>New Game</button> -->
<button class="btn btn-small btn-primary w-full" on:click={returnBackGame}>Return Game</button>
